...
function Jogador(posicao, nome = null) {
...
const criarJogador1 = () => {  
  return new Promise((resolve, reject) => {
    rl.question('Qual o nome do jogador 1? ', (resposta) => {
        jogador1 = new Jogador(1, resposta);  // Cria o objeto jogador1, a partir do construtor
        resolve();
    });
  })
}
...
const criarJogador2 = () => {
  return new Promise((resolve, reject) => {
    rl.question('Qual o nome do jogador 2? ', (resposta) => {
        jogador2 = new Jogador(2, resposta);  // Cria o objeto jogador2, a partir do construtor
        resolve();
    });
  })
}
